...
if __name__ == "__main__":
    ...
    assert args.metric in ["number_of_events_to_depot", "number_of_packets_to_depot", "packet_mean_delivery_time",
                           "event_mean_delivery_time", "packet_delivery_ratio"]
    pattern_file = config.EXPERIMENTS_DIR + "out__{}_{}_RoutingAlgorithm.{}.json"
    out_dir = config.SAVE_PLOT_DIR
    plot_ndrones(pattern_file, args.number_of_drones, args.metric, args.algorithms,
                 list(range(args.initial_seed, args.end_seed)), out_dir)
